...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "Chodna": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Mr chodna ☜\nFacebook: https://www.facebook.com/profile.php?id=100060789990593\nWhatsApp: +88018****",
    "admin": "He is Akku তাকে সবাই Mr Chodna হিসেবে চিনে😘☺️",
    ...
    "ami Akku": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌RBDC 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "ki koros": "বস আক্কু এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    ...
    "trip": " অফিসিয়াল ট্রিপ দুপর ৩ টায় সবাই প্রস্তুত হও🔥"
    "trip2": " অফিসিয়াল ট্রিপ রাত ১০ টায়  সবাই প্রস্তুত হও"
    "trip3": "  অফিসিয়াল ট্রিপ রাত ১২টায় সবাই প্রস্তুত হও"
  };
